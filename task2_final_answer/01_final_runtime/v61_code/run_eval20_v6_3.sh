...
RUN_OUT="${V63_EVAL_RUN:-$V61/results/eval20_4cps_v6_3_initial/shard-001}"
CASE_FILE="${V63_CASE_FILE:-$V61/code/eval20_cases_v6_3.txt}"
...
python production_runner_v6_3.py \
...
echo "Initial V6.3 eval completed: $RUN_OUT"
echo "Next: run replay_full_batch_v6_3.py on this shard before any repair."
