...
def main() -> int:
    ...
    for initial_path in task_paths:
        ...
        if outcome == "UNKNOWN" and cp == "CP15":
            ...
            diagnosis = "UNRESOLVED_AFTER_V6_4_2"
    ...
    payload = {
        "schema": "freca-v6.4.2-full-batch-zero-api-replay-v1",
    ...
    save({
        "schema": "freca-v6.4.2-conflict-audit-v1",
        "conflicting_coordinate_count": len(conflicts),
    ...
    md = []
    md += ["# V6.4.2 full-batch zero-API replay", ""]
    ...
    print("# V6.4.2 full-batch zero-API replay")
