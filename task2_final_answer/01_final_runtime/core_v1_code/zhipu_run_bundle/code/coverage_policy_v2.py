    ...
    *,
    ...
    for need_id, trace in sorted(traces.items()):
        ...
        if purpose in {"POSITIVE_EXISTENCE_PROOF", "EXPLICIT_ADVERSE_PROOF"}:
            proof_pass = bool(positive_basis and countercheck_complete)
            status = (
                "POSITIVE_BASIS_AND_COUNTERCHECK_COMPLETE"
                if proof_pass
                else (
                    "POSITIVE_BASIS_COUNTERCHECK_PENDING"
                    if positive_basis
                    else "NO_EXPLICIT_BASIS"
                )
            )
        ...
        if positive_basis and not countercheck_complete and purpose in {
            ...
            limiting.append("COUNTEREVIDENCE_PROCEDURE_INCOMPLETE")
    ...
    bundle = {
        ...
        "coverage_policy_version": "PURPOSE_SPECIFIC_COVERAGE_V2_1",
        ...
        "invariants": {
            ...
            "positive_and_adverse_proofs_require_countercheck": True,
        },
    }
