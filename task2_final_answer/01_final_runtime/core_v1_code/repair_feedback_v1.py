...
def merge_round_into_requirement_result(
    ...
    merged["schema"] = (
        "freca-core-requirement-reasoning-v2-repair-merged-v1"
    )
...
def verified_signal_gain(round_bundle: dict) -> dict:
    ...
    return {
        ...
        # Main metric: only truth-bearing or decisively resolved typed signals.
        ...
        # Useful but deliberately not truth-bearing.
...
def run_self_tests() -> None:
    ...
    print("repair_feedback_v1 self-tests: PASS")
