...
def compile_one(v2, cp_id, contract_dir, run_dir, policy_top_k, max_attempts, initial_error):
    ...
    for attempt in range(1, max_attempts + 1):
        hint = hint_for(error)
        original_deepseek = install_prompt_hint(v2, hint)
        ...
        try:
            ...
            v2.deepseek_json = original_deepseek
...
def self_test():
    ...
    print("contract_failure_closure_v1 self-tests: PASS")
