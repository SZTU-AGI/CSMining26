...
SCHEMA = "freca-v6.4.3-structural-witness-audit-v1"
...
def _validated_synthetic_alignment(
    *,
    ...
    row["reason"] = reason
    row["generator"] = "STRUCTURAL_AUDIT_V6_4_3"

    # V6.4.3 scope fix: only the CP12 ER1 holistic design SUPPORT aggregate
    # receives the derived-record reliability nature override.  V6.4.2 applied
    # this rewrite to every structural family, which regressed already-stable
    # CP1/CP26/CP35 witnesses by replacing their established evidence nature
    # and reliability assessment.  All other structural witnesses retain the
    # ordinary V6.4 validate_alignment output unchanged.
    if aggregate_kind == "HOLISTIC_MULTI_SECTION_SUPPORT" and relation == "SUPPORT":
        ...
        row["structural_reliability_override"] = "CP12_ER1_DESIGN_SUPPORT_ONLY"
    return row
...
def enrich_requirement_result(requirement_result: dict, evidence_chunks: list[dict]) -> tuple[dict, dict]:
    ...
    audit = {
        ...
        "invariants": {
            ...
            "structural_record_nature_drives_common_reliability_gate": "CP12_ER1_DESIGN_SUPPORT_ONLY",
